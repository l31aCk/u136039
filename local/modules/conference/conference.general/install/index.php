...
Битрикс CModule*/
Class conference_general extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "conference.general";
    var $MODULE_ID = "conference.general";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("conference.general_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("conference.general_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("conference.general_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("conference.general_PARTNER_URI");
    }
