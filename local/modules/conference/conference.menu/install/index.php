...
Битрикс CModule*/
Class conference_menu extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "conference.menu";
    var $MODULE_ID = "conference.menu";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("conference.menu_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("conference.menu_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("conference.menu_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("conference.menu_PARTNER_URI");
    }
