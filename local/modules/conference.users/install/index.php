...
Битрикс CModule*/
Class conference_users extends CModule {
    /*Обязательные свойства объекта модуля*/
    const MODULE_ID = "conference.users";
    var $MODULE_ID = "conference.users";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = GetMessage("conference.users_MODULE_NAME");
        $this->MODULE_DESCRIPTION =
            GetMessage("conference.users_MODULE_DESC");
        $this->PARTNER_NAME = GetMessage("conference.users_PARTNER_NAME");
        $this->PARTNER_URI = GetMessage("conference.users_PARTNER_URI");
    }
